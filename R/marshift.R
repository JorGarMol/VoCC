...
#' @keywords datasets
#'
#' @format An extract from the meta data set provided used by Poloczanska
...
#'
#' @references Brown et al. 2016. Ecological and methodological drivers of
#' species distribution and phenology responses to climate change.
#' Global Change Biol., 22, 1548-1560.
#' (\href{https://onlinelibrary.wiley.com/doi/full/10.1111/gcb.13184}{PubMed})
#'
#' Poloczanska et al. 2013. Global imprint of climate change on marine life.
#' Nat. Clim. Change, 3, 919-925.
#' (\href{https://www.nature.com/articles/nclimate1958}{PubMed})
"marshift"
