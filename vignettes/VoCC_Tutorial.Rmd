...
Next, we calculate the gradient- and distance-based velocities (1960-2009) from which we will later extract the corresponding values for each observed shift.
